...
(function() {
	...
	Help.renderHelpText = function(view, ctx, x, y, height, helpLine) {
		...
		y = this.renderHelpLine(view, Keywords.labelWord + " X Y " + Keywords.stringDelimiter + "<string>" + Keywords.stringDelimiter, "define label at position", ctx, x, y, height, helpLine);

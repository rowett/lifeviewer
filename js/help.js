...
(function() {
	...
	Help.renderScriptsTopic = function(view, ctx, x, y, height, helpLine) {
		...
		y = this.renderHelpLine(view, " 0  " + Keywords.pasteModeZeroWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 1  " + Keywords.pasteModeAndWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 2  " + Keywords.pasteMode0010Word, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 3  " + Keywords.pasteModeXWord + "|" + Keywords.pasteModeCopyWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 4  " + Keywords.pasteMode0100Word, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 5  " + Keywords.pasteModeYWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 6  " + Keywords.pasteModeXorWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 7  " + Keywords.pasteModeOrWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 8  " + Keywords.pasteModeNOrWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 9  " + Keywords.pasteModeXNOrWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 10 " + Keywords.pasteModeNotYWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 11 " + Keywords.pasteMode1011Word, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 12 " + Keywords.pasteModeNotXWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 13 " + Keywords.pasteMode1101Word, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 14 " + Keywords.pasteModeNAndWord, "", ctx, x, y, height, helpLine);
		y = this.renderHelpLine(view, " 15 " + Keywords.pasteModeOneWord, "", ctx, x, y, height, helpLine);

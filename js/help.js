...
(function() {
	...
	Help.renderKeysTopic = function(view, ctx, x, y, height, helpLine) {
		...
		y = this.renderHelpLine(view, "Ctrl Space", "advance paste generation", ctx, x, y, height, helpLine);
		...
		if (view.engine.isLifeHistory) {
			y = this.renderHelpLine(view, "Shift Del", "clear [R]History cells", ctx, x, y, height, helpLine);
		}

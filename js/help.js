...
(function() {
	...
	Help.renderScriptsTopic = function(view, ctx, x, y, height, helpLine) {
		...
		y = this.renderHelpLine(view, Keywords.arrowSizeWord + " <" + ViewConstants.minArrowSize + ".." + ViewConstants.maxArrowSize + "> <1..>", "line width and head ratio", ctx, x, y, height, helpLine);

 ...
 */
	...
	Help.renderKeysTopic = function(/** @type {View} */ view, /** @type {CanvasRenderingContext2D} */ ctx, /** @type {number} */ x, /** @type {number} */ y, /** @type {number} */ height, /** @type {number} */ helpLine) {
		...
		y = this.renderHelpLine(view, "Left Button", "use button / draw / select", ctx, x, y, height, helpLine);
	...
	Help.renderScriptsTopic = function(/** @type {View} */ view, /** @type {CanvasRenderingContext2D} */ ctx, /** @type {number} */ x, /** @type {number} */ y, /** @type {number} */ height, /** @type {number} */ helpLine) {
		...
		y = this.renderHelpLine(view, Keywords.zoomWord + " <" + Number(-1 / ViewConstants.minZoom).toFixed(1) + ".." + (view.maxZoom).toFixed(1) + ">", "set camera zoom", ctx, x, y, height, helpLine);
		...
		y = this.renderHelpLine(view, Keywords.thumbZoomWord + " <" + Number(-1 / ViewConstants.minZoom).toFixed(1) + ".." + (view.maxZoom).toFixed(1) + ">", "set thumbnail zoom", ctx, x, y, height, helpLine);
				...
				if (view.lastIdentifyStrict === "") {
					...
					if (view.engine.cellPeriodState6) {
						...
						if (view.engine.isExtended) {
							y = this.renderHelpLine(view, "  Off DF", "    " + view.engine.cellPeriodState6 + "\t\t\t" + this.rgbString(0x60, 0x60, 0x60).trim(), ctx, x, y, height, helpLine);
						} else {
							y = this.renderHelpLine(view, "  Off DF", "    " + view.engine.cellPeriodState6 + "\t\t\t" + this.rgbString(0x60, 0x60, 0x60).trim(), ctx, x, y, height, helpLine);
						}
					}

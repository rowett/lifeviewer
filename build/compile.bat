...
"C:\Program Files\Java\jre1.8.0_321\bin\java.exe" -jar compiler.jar -W VERBOSE --jscomp_off=checkVars --compilation_level ADVANCED_OPTIMIZATIONS --js=all.js --js_output_file=lv-plugin.js
